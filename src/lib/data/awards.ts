...
export const awards: Award[] = [
  ...
  },
  {
    ...
    title: 'Quality Prime',
    description:
      'Reconhecimento máximo de excelência em qualidade, concedido às empresas que atingem os mais altos padrões de desempenho e satisfação.',
  ...
  },
  {
    ...
    description:
      'Certificação de qualidade conferida às empresas que demonstram compromisso com a melhoria contínua e excelência no atendimento.',
